...
A beta kata which receives two posts labeled as `issue` is automatically unpublished and turned back into a draft. It cannot be republished until all existing issues are resolved, but authors can republish after fixing all reported problems.
