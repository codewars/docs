...
A beta kata which receives two posts labeled as `issue` is automatically unpublished and turned back into a draft. It cannot be republished until there is at least one unresolved issue.
