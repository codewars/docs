...
You can search for additional help on the Codewars Gitter chats: [general](https://gitter.im/Codewars/Codewars.com) or [kata solving help](https://gitter.im/Codewars/Codewars.com/kata-solving-help). There’s always someone hanging out there, and usually users are very willing to help. Usually.
