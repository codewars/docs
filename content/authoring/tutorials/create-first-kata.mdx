...
Over the course of the review period, your kata might get automatically unpublished after collecting a certain amount of issues. Automatic unpublishing is not the end of the road for your kata. While back in draft, take note of the issues and fix the underlying problems in your kata. Once you've implemented those, you can resolve the issues and re-publish. For more details on the auto-unpublish feature see description of the [beta process](/curation/kata#auto-unpublish).
