...
Through the course of review, your kata could get automatically unpublished after collecting some amount of issues. You are free to fix the issues, mark them as resolved, and publish your kata again. You will not be able to republish your kata until all reported problems are addressed. For more details on auto-unpublish feature see description of the [beta process](/curation/kata#auto-unpublish).
