...
- **Leaderboards**: Codewars manages different kinds of [leaderboards](https://www.codewars.com/users/leaderboard) which show users with the highest amounts of Honor considering different kinds of situations/actions.
